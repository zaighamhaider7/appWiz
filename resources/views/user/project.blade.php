            ...
            <div class="p-6 light-bg-bill lg:p-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-1 gap-6 mb-6">
                    ...
                    <div class="lg:col-span-2 light-bg-f5f5f5 light-bg-seo  rounded-xl shadow-sm">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody id="project-table-body"
                                    ...
                                    {{-- <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm light-text-gray-900">$4,000</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm light-text-gray-900">12/08/2025
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm light-text-gray-900">12/09/2025
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="w-52 bg-gray-200 rounded-full h-2.5">
                                                    <div class="bg-green-500 h-2.5 rounded-full" style="width: 78%">
                                                    </div>
                                                </div>
                                                <span class="ml-2 text-sm light-text-gray-700">78%</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex ml-8 items-center ">
                                                ...
                                                <span
                                                    class="ml-2 text-sm items-center light-text-gray-800">InProgress</span>
                                            </div>
                                        </td>
                                    ...
                                    {{-- <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm light-text-gray-900">$4,000</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm light-text-gray-900">12/07/2025
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm light-text-gray-900">12/11/2025
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="w-52 bg-gray-200 rounded-full h-2.5">
                                                    <div class="bg-cyan-400 h-2.5 rounded-full" style="width: 69%">
                                                    </div>
                                                </div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex ml-8 items-center ">
                                                <div class="bg-gray-200 rounded-full w-2.5 h-2.5">
                                                    <div class="bg-yellow-500 h-2.5 rounded-full w-full"></div>
                                                </div>
                                                <span
                                                    class="ml-2 text-sm items-center light-text-gray-800">Delayed</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <button class="light-text-orange-500 light-hover-text-orange-700"
                                    ...
                                    {{-- <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm light-text-gray-900">$4,000</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm light-text-gray-900">20/10/2025
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm light-text-gray-900">24/12/2025
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="w-52 bg-gray-200 rounded-full h-2.5">
                                                    <div class="bg-yellow-500 h-2.5 rounded-full" style="width: 43%">
                                                    </div>
                                                </div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex ml-8 items-center ">
                                                ...
                                                <span
                                                    class="ml-2 text-sm items-center light-text-gray-800">Complete</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <button class="light-text-orange-500 light-hover-text-orange-700"
                                    ...
                                    {{-- <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm light-text-gray-900">$4,000</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm light-text-gray-900">10/09/2025
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm light-text-gray-900">21/11/2025
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="w-52 bg-gray-200 rounded-full h-2.5">
                                                    <div class="bg-red-400 h-2.5 rounded-full" style="width: 15%">
                                                    </div>
                                                </div>
                                                <span class="ml-2 text-sm light-text-gray-700">15%</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex ml-8 items-center ">
                                                <div class="bg-gray-200 rounded-full w-2.5 h-2.5">
                                                    <div class="bg-cyan-500 h-2.5 rounded-full w-full"></div>
                                                </div>
                                                <span
                                                    class="ml-2 text-sm items-center light-text-gray-800">InProgress</span>
                                            </div>
                                    ...
                                    {{-- <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm light-text-gray-900">$4,000</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm light-text-gray-900">01/11/2025
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm light-text-gray-900">28/12/2025
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center ">
                                                <div class="w-52 bg-gray-200 rounded-full h-2.5">
                                        ...
                                        <td class="px-6 py-4  whitespace-nowrap">
                                            <div class="flex ml-8 items-center ">
                                                <div class="bg-gray-200 rounded-full w-2.5 h-2.5">
                                                    <div class="bg-red-400 h-2.5 rounded-full w-full"></div>
                                                </div>
                                                <span
                                                    class="ml-2 text-sm items-center light-text-gray-800">Cancelled</span>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <button class="light-text-orange-500 light-hover-text-orange-700"
                        ...
                        <!-- Table Pagination -->
                        <div
                            class="flex items-center justify-between p-4 mt-4 mb-4 text-sm light-text-gray-600 flex-wrap gap-2">
                            <div>
                                    ...
                                    rows += `
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400">
                                                <div class="flex ml-8 items-center">
                                                    <div class="bg-gray-200 rounded-full w-2.5 h-2.5">
                                                        <div class="${statusColor} h-2.5 rounded-full w-full"></div>
                                                    </div>
                                                    <span class="ml-2 text-sm light-text-gray-800">
                                                        ${statusText}
                                                    </span>
                                                </div>
                                            </td>
