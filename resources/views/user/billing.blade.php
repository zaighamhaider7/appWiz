...
<body>
    <div class="flex min-h-screen light-bg-white">
        ...
        <main class="flex-1  overflow-y-auto">
            ...
            <div class="p-6 -mt-5 lg:p-8 light-bg-bill">

                <div>

                    <!-- Projects Title -->
                    <h1 class="text-3xl font-bold light-text-gray-800 mb-10">Billings</h1>

                    <!-- Connect Domain Section -->

                    <div
                        class="hidden md:flex border-b py-3 px-6 gap-5 light-border-gray-200 dark:border-gray-700  mb-10">
                        <!-- Tab 1: Overview -->
                        <div
                            ...
                            <img class="w-4 h-4 mr-2" src="{{ asset('assets/receipt-item.svg') }}" alt="">
                            <button class="tab-btn p-1 tab-button " data-tab="overview">Billings</button>
                        </div>
                        <!-- Other tabs... -->
                        <!-- Tab 2: Notes -->
                        <div
                            ...
                            <img class="w-4 h-4 mr-2" src="{{ asset('assets/card.svg') }}" alt="">
                            <button class="tab-btn font-medium " data-tab="notes">Payment Method</button>
                        </div>
                        ...
                        <div
                            ...
                            <img class="w-4 h-4 mr-2" src="{{ asset('assets/ticket-svgrepo-com.svg') }}"
                                class="text-white" alt="">
                            <button
                                class="tab-btn font-medium light-text-gray-500 dark:text-gray-400 hover:light-text-gray-700 dark:hover:text-gray-300"
                                data-tab="uploadedDocument">Subscriptions</button>
                        </div>
                    ...
                    <div class="tab-contents">
                                        ...
                                        <tbody class="light-bg-white light-bg-seo border-b-4 light-border-gray-300">
                                            ...
                                            <tr class="border-b-4 light-border-gray-300">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm font-thin light-text-gray-900"> Product
                                                        Photography and Cataloging </div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <span
                                                        class="px-2 inline-flex text-xs text-gray-400 leading-5 font-semibold rounded-full">$5000</span>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-400">Yesterday
                                                    at 03:03 pm</td>
                                                    ...
                                                    <div class="flex justify-center gap-2">
                                                        <button
                                                            ...
                                                            <img src="document-download.svg" alt="icon"
                                                                ...
                                                                data-dark-src="{{ asset('assets/document-download-DARK.svg') }}">
                                                        </button>
                                                        <button
                                                            class="light-text-orange-500 bg-gray-200 p-1 rounded-full light-hover-text-orange-700 open-ticket-modal"
                                                            data-action="view-project">
                        ...
                        <div id="notesContent" class="tab-content hidden">
                            ...
                            <div>
                                ...
                                <div class="flex justify-between mb-10">
                                    <h3 class="text-black dark:text-[#AFAFAF] text-lg font-thin">Payment methods</h3>
                                    <button
                                        class="bg-orange-500 p-2 rounded-lg text-white font-medium openTicketModal">Add
                                ...
                                <div class="flex light-border-gray-300 border-2 p-3 mb-5 rounded-lg justify-between">
                                    <div>
                                        ...
                                        <p class="light-text-black text-md font-thin">**** **** **** 9856</p>
                                    </div>
                                    <div>
                                        <button
                                            class="light-bg-gray-900 border-2 light-border-gray-300 py-1 px-5 text-sm text-white rounded-lg font-thin openPaymentModal">Edit</button>
                                        <button
                                ...
                                <div class="flex light-border-gray-300 border-2 p-3 mb-5 rounded-lg justify-between">
                                    <div>
                                        ...
                                        <div class="flex items-center mb-5 gap-4">
                                            <h3 class="light-text-black text-md font-thin">Tom McBride</h3>
                                            <span
                                                class="inline-block px-2 py-1 rounded-sm text-xs text-orange-500 bg-orange-900 bg-opacity-50">
                                                Primary
                                            </span>
                                        </div>
                                        <p class="light-text-black text-md font-thin">**** **** **** 5823</p>
                                    </div>
                                    <div>
                                        <button
                                            class="light-bg-gray-900 border-2 light-border-gray-300 py-1 px-5 text-white text-sm rounded-lg font-thin openPaymentModal">Edit</button>
                                        <button
                                            class="mb-14 light-transparent border-2 light-border-gray-300 py-1 px-5 text-sm rounded-lg font-thin">Delete</button>
                                        <div class="flex justify-end">
                                ...
                                <div class="flex light-border-gray-300 border-2 p-3 mb-5 rounded-lg justify-between">
                                    <div>
                                        ...
                                        <h3 class="light-text-black text-md mb-5 font-thin">Mildred Wagner</h3>
                                        <p class="light-text-black text-md font-thin">**** **** **** 5896</p>
                                    </div>
                                    <div>
                                        <button
                                            class="light-bg-gray-900  border-2 light-border-gray-300 py-1 px-5 text-sm text-white rounded-lg font-thin openPaymentModal">Edit</button>
                        ...
                        <div id="uploadedDocumentContent" class="tab-content hidden">
                                        ...
                                        <tbody class="light-bg-white light-bg-seo divide-y divide-gray-200">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    ...
                                                    <div
                                                        class="bg-green-900 bg-opacity-50 rounded-sm w-12 items-center px-2">
                                                        <p class="text-green-400  pr-4 text-xs">Active</p>
                                                    </div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <span
                            ...
                            <div id="addCredentialsContent" class="tab-content hidden">
                                ...
                                <!-- Overview Cards -->
                                <div>
                                    <h3 class="pb-3 font-semibold text-md light-text-black">Wizspeed Social Media
                                        Marketing Packages</h3>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 " id="seo-cards">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="bg-orange-600 px-5 py-1 text-white rounded-md text-md">
                                    ...
                                    <div
                                        ...
                                        <p class="light-text-black text-sm font-bold mb-6">Authority & Visibility Boost
                                        </p>
                                    ...
                                    <div
                                        ...
                                        <p class="light-text-black text-sm font-bold mb-6">Full Strategy & National
                                            Reach</p>
                                        <!-- Toggle Button -->
        ...
        <div
            ...
            <form id="ticketForm" class="space-y-4 p-6">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        <label class="block text-sm mb-1 light-text-black">Card Holder Name</label>
                    ...
                    <div class="grid-cols-1 gap-4">
                        <div>
                            ...
                            <div class="relative flex-grow">
                                <input type="text" name="title" placeholder="1234 **** **** ****"
                                ...
                                <div class="absolute right-2 top-1/2 transform -translate-y-1/2 flex gap-2">
                                    <img src="{{asset('assets/paypal.svg')}}" class="w-8 h-8" alt="PayPal">
                                    <img src="{{asset('assets/visa-4-logo-svgrepo-com.svg')}}" class="w-8 h-8" alt="Visa">
                                    <img src="{{asset('assets/mastercard-3-svgrepo-com.svg')}}" class="w-8 h-8" alt="Mastercard">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="grid-cols-2 grid gap-4">
                        <div>
                            ...
                            <div class="relative flex-grow">
                                <input type="text" name="title" placeholder="123"
                                    class="w-full p-2 pr-16 rounded light-bg-d7d7d7 border border-gray-700 text-white focus:outline-none">
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="relative flex-grow">
                                <input type="text" name="title" placeholder="08/12"
                                    class="w-full p-2 pr-16 rounded light-bg-d7d7d7 border border-gray-700 text-white focus:outline-none">
                                <div class="absolute right-2 top-1/2 transform -translate-y-1/2 flex gap-2">
                                    <img src="{{asset('assets/calendar.svg')}}" class="w-8 h-8" alt="PayPal">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="grid-cols-1 gap-4">
                        <div>
                            <label class="block text-sm mb-1 light-text-black">Address Line 1 (optional)</label>
                            <div class="relative flex-grow">
                                <input type="text" name="title" placeholder="Address here"
                                    class="w-full p-2 pr-16 rounded light-bg-d7d7d7 border border-gray-700 text-white focus:outline-none">
                            </div>
                        </div>
                    </div>
    ...
    <div id="paymentModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center z-50 justify-center hidden">
        <div
            ...
            <div class="px-6 py-3">
                <h2 class="text-lg light-text-black font-semibold">Edit Payment Method</h2>
            </div>
            <div class="border-t border-gray-600 w-full mt-4"></div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <div class="absolute right-2 top-1/2 transform -translate-y-1/2">
                                <img src="{{asset('assets/calendar.svg')}}" class="w-6 h-6" alt="Calendar">
                            </div>
                        </div>
                    </div>
                </div>
