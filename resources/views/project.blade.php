    ...
    <div class="container align-content-center mt-5">
        <form method="POST" action="{{ route('project.store') }}" enctype="multipart/form-data">
            ...
            <div data-mdb-input-init class="form-outline mb-4">
                <input type="text" id="form6Example3" name="project_name" class="form-control" />
            ...
            <div class="col">
                <div data-mdb-input-init class="form-outline">
                    <input type="file" id="document_name" name="document_name" class="form-control" />
                    <label class="form-label" for="document_name">Select File</label>
            </div>
            ...
            <!-- Submit button -->
            <button data-mdb-ripple-init type="submit" class="btn btn-primary btn-block mb-4">Add Projects</button>
        </form>
        ...
        <tbody>
            @foreach ($projects as $project)
                <tr>
                    ...
                    <td><a href="{{ route('project.view', $project->id) }}">Update</a></td>
...
<body>
            ...
            <header class="flex items-center justify-between light-bg-f5f5f5 light-bg-seo p-5 shadow-sm mb-2 header">
                ...
                <div class="flex items-center space-x-4 ml-4">
                    ...
                    <div class="flex items-center p-1 space-x-3 rounded-full border-2 light-border-gray-300">
                        <img src="{{ asset('assets/Ellipse 3.png') }}" alt="User Avatar"
                                    ...
                                    @foreach($projects as $project)
                                     <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium light-text-gray-900">{{ $project->project_name }}</div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <button
                                                ...
                                                <img src="{{ asset('assets/Avatar Group.svg') }}" alt="">
                                            </button>
                                        </td>
                                    </tr>
                                    @endforeach
                                        ...
                                        <td colspan="7" class="px-6 py-4 ">
                                            ...
                                            <div class="grid grid-cols-6 pt-2 mt-2 light-text-black">
                                                ...
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <img src="{{asset('assets/document-download-DARK.svg')}}" id="openModalBtn"
                                                        alt="Action 1" class="w-6 h-6 rounded-full p-1 bg-gray-500" />
        ...
        <div class="light-bg-white  rounded-xl  w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-xl">
            ...
            <div class="relative">
                ...
                <div class="hidden md:flex light-bg-d9d9d9 px-5 py-2  mb-10">
                    ...
                    <div
                        class="flex items-center px-2 py-1 justify-center rounded-sm hover:rounded-md light-hover-bg-gray-300 tab-wrapper">
                        <img class="w-4 h-4 mb-2" src="{{asset('assets/bookmark.svg')}}" alt="">
                        <button
                            ...
                            data-tab="uploadedDocument">Memberships</button>
                    </div>
                        ...
                        <div class="grid-cols-1 gap-4">
                            <div class="grid grid-cols-2 gap-2">
                                <div>
                                    ...
                                    <select
                                        class="w-full p-2 rounded light-bg-d7d7d7 border border-gray-700 light-text-black" name="client_name">
    ...
    <div id="taskModal"
        ...
        <div class="light-bg-white  rounded-xl  w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-xl">
            ...
            <div class="relative">
                ...
                <div class="hidden md:flex light-bg-d9d9d9 px-5 py-2  mb-10">
                    ...
                    <div
                        ...
                        <button
                            class="task-tab-btn open-membership-modal mb-2 px-2 font-medium light-text-gray-500 dark:text-gray-400 hover:light-text-gray-700 dark:hover:text-gray-300"
                            data-tab="taskTab3">Memberships</button>
                    </div>
                ...
                <div class="md:hidden overflow-x-auto whitespace-nowrap py-4 scrollbar-hide">
                    <div class="inline-flex space-x-8 px-4">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <button
                                class="taask-tab-btn pt-2 font-medium light-text-gray-500 dark:text-gray-400 hover:light-text-gray-700 dark:hover:text-gray-300"
                                data-tab="notes">Notes</button>
                        </div>
            ...
            <div id="taskTab1" class="task-tab-content px-6">
                ...
                <form id="ticketForm" class="space-y-4 mb-10 " method="POST" action="{{ route('project.store') }}" enctype="multipart/form-data">
                    @csrf
                    <!-- Title, Project Name, Priority -->
                    <div class="grid grid-cols-1 gap-4">
                        <div class="grid grid-cols-1 gap-2">
        ...
        <div class="w-full max-w-[70vw] max-h-[90vh] overflow-y-auto ">
            <div class="light-bg-f5f5f5 light-bg-seo rounded-lg shadow-lg w-full  light-text-black relative">
                ...
                <button id="closeModalBtn"
                    class="absolute top-3 right-3 text-gray-400 hover:text-black dark:hover:text-white rounded-full border border-gray-200">
    ...
    <div id="milestoneEditModal"
        ...
        <div class="bg-[#1f1f1f] p-6 rounded-lg w-full max-w-[70vw] text-white">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-xl font-bold">Edit New Milestone</h2>
